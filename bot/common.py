...
from telegram import Update, ReplyMarkup, ParseMode
from telegram.ext import CallbackContext

from config import DIR_LOGS, MAX_MESSAGE_LENGTH, ERROR_TEXT
...
def process_error(log: logging.Logger, update: Update, context: CallbackContext):
    ...
    if update:
        reply_message(ERROR_TEXT, update, severity=SeverityEnum.ERROR)
